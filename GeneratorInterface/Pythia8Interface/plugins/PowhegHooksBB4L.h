...
// inspired by GeneratorInterface/Pythia8Interface/plugins/PowhegHooksForBB4L.h by Richard Corke
...
#include "GeneratorInterface/Pythia8Interface/plugins/PowhegHooksForBB4L.h"
...
class PowhegHooksBB4L : public PowhegHooksForBB4L {
...
//--- Initialization -----------------------------------------------------------------------
	...
	bool initAfterBeams() {
		...
		PowhegHooksForBB4L::initAfterBeams();
...
//--- FSR EMISSION LEVEL HOOK ----------------------------------------------
	...
	//           OR PowhegHooksForBB4L veto in production. (The virtual method
	//           PowhegHooksForBB4L::canVetoFSREmission has been replaced by
	//           PowhegHooksBB4L::canVetoFSREmission, so FSR veto in production
	//           must be handled here. ISR and MPI veto are instead still
	//           handled by PowhegHooksForBB4L.)
...
//using pythia pT definition ...
		...
		/////////////////////////////////
			...
			return PowhegHooksForBB4L::doVetoFSREmission(sizeOld, e, iSys, inResonance);
		}
		cout << "Bug in doVetoFSREmission function: control reaches end of non-void function" << endl; //Added by J. Fernandez to amke this compile in CMSSW
		return false; //Added by J. Fernandez to amke this compile in CMSSW
	}
