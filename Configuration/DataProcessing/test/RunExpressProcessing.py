...
python RunExpressProcessing.py --scenario cosmics --global-tag GLOBALTAG --lfn /store/whatever --fevt --dqmio --dqmSeq=@express --alcarecos=TkAlCosmics0T+SiStripCalZeroBias
